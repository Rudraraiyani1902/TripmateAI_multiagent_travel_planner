...
def clean_text(text:str) -> str:
    ...
    stop_words = [
        "flight", "flights","ticket", "tickets", "airline", "airlines", "airport", "airports","trip","travel","plan","complete","days","day","including","hotel","hotels","sightseeing","under","budget","info"]
...
def airport_country_matches(airport: dict, country_code: str) -> bool:
    airport_country = str(airport.get("country", "")).strip()
